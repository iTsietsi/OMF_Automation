...
public class Reporting extends TestListenerAdapter {
    ...
    public void onStart(ITestContext tr){
        ...
        String reportName = "OMF Automation Test Report-" + timeStamp + ".html";
        ...
        extent.setSystemInfo("Organization", "Old Mutual");
        extent.setSystemInfo("Environment", "Test");
        extent.setSystemInfo("User", "Tsietsi");
        extent.attachReporter(htmlReporter);

        htmlReporter.config().setDocumentTitle("OMF Test Automation"); // Report title
        htmlReporter.config().setReportName("Automation Functional Testing Report"); // Report name
